    ...
    <div className="dashboard-container">
      <div className="header">
        ...
        <div className="header-right">
          ...
          <button className="logout" onClick={() => {localStorage.clear(); window.location.href="/"}}>Logout</button>
      ...
      {cart.length > 0 && (
        <div className="cart-section">
          ...
          <div className="checkout-btn">
            <button className="btn approve" onClick={checkout}>Checkout (${cart.reduce((sum, item) => sum + (item.price * item.qty), 0)})</button>
          </div>
        </div>
      )}
